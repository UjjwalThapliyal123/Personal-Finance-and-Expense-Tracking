...
#creating the connection between streamlit and sql
...
def home_page():#homepage
   ...
   # Page Title
    ...
    # Description
    st.write("""
     Application that helps you manage your personal finances by tracking your income, 
    expenses, and savings. It provides a simple interface to log your daily expenses and 
    visualize your financial health with graphs and summaries.
    """)
...
def last_page():# end page summary
...
def main():# function to execute all the pages
